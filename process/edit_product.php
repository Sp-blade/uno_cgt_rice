<?php
	...
	switch($mainMenu){
		...
		case "product_list":
			...
			$sql_editProduct = "UPDATE products SET ProductType = '$productType', ProductBaseUnit = '$productBaseUnit', ProductPrice = '$productPrice', SellingPrice = '$sellingPrice', StockLimit = '$stockLimit', CanConvertToKg = '$canConvertToKg', KgEquivalentQty = '$kgEquivalentQty', ParentProduct_ID = '$parentProductId', IsSubProduct = '$isSubProduct' WHERE Product_ID = '$product_id'";
		...
		case "view_sale":
			...
			$saleUnit = strtolower(trim((string) ($_GET['sale_unit'] ?? 'pc'))) === 'kg' ? 'kg' : 'pc';
